...
import urllib
import urlparse
from converts import encrypt_aes_128_ctr, decrypt_aes_128_ctr
import os
...
def target(cipher):
    plain = str(decrypt_aes_128_ctr(cipher, KEY, NONCE))
